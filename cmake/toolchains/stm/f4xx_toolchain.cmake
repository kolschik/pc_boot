...
if (PLATFORM_TYPE STREQUAL "HARD")
    if (MODULE_BOOTLOADER STREQUAL "ON")
        ...
        elseif (CMAKE_BUILD_TYPE STREQUAL "Release-loader" OR CMAKE_BUILD_TYPE STREQUAL "Debug-loader" OR CMAKE_BUILD_TYPE STREQUAL "Release")
...
if (PLATFORM_TYPE STREQUAL "HARD")
    ...
    set(CPP_FLAGS_ALL_MODE "-std=c++14 -Wno-type-limits -fno-exceptions -ffunction-sections -fdata-sections -fno-rtti")
...
if (CMAKE_BUILD_TYPE STREQUAL "Debug" OR CMAKE_BUILD_TYPE STREQUAL "Debug-noloader")
    ...
    set(CMAKE_EXE_LINKER_FLAGS_INIT "${COMMON_FLAGS} -Os -g3 ${LINK_ALL_MODE_FLAGS}")
